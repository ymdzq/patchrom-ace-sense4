...
.method private AliveExtSdCardRows(II)V
    ...
    const-string v14, "[MediaScannerService][AliveExtSdCardRows]+"
    ...
    .line 338
    .local v4, imagesUri:Landroid/net/Uri;
    const-string v12, "external"
    ...
    invoke-virtual {v12, v1, v9, v11, v13}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v12, v10, v9, v11, v13}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v12, v4, v9, v11, v13}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v12, v3, v9, v11, v13}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 355
    .end local v1           #audioUri:Landroid/net/Uri;
    .end local v3           #filesUri:Landroid/net/Uri;
    .end local v4           #imagesUri:Landroid/net/Uri;
    .end local v5           #n1:I
    .end local v6           #n2:I
    .end local v7           #n3:I
    .end local v8           #n4:I
    .end local v9           #values:Landroid/content/ContentValues;
    .end local v10           #videoUri:Landroid/net/Uri;
    ...
    const-string v13, "failed to open media database"
...
.method private deleteRowsEquaulVolid(I)V
    ...
    .line 200
    :try_start_0
    sget-boolean v6, Lcom/android/providers/media/MediaProvider;->mbMyLog:Z
...
.method private disAliveExtSdCardRows()V
    ...
    const-string v12, "[MediaScannerService][disAliveExtSdCardRows]+"
    ...
    invoke-virtual {v11, v0, v8, v10, v12}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v11, v9, v8, v10, v12}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v11, v3, v8, v10, v12}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v11, v2, v8, v10, v12}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v13, "[MediaScannerService][disAliveExtSdCardRows]-"
    ...
    const-string v12, "failed to open media database"
...
.method private scan([Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v7, "[MediaScannerService][scan]+"
    ...
    const-string v6, "[MediaScannerService][scan]-"
