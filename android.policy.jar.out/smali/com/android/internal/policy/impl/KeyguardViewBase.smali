...
.method private interceptMediaKey(Landroid/view/KeyEvent;)Z
    ...
    :cond_3
    :sswitch_1
    sget-boolean v4, Lcom/android/internal/policy/impl/KeyguardViewBase;->DEBUG_MEDIA:Z

    if-eqz v4, :cond_4

    sget-object v4, Lcom/android/internal/policy/impl/KeyguardViewBase;->TAG:Ljava/lang/String;
    ...
    const-string v7, " , Action = DOWN , sendOrderedBroadcast:"
    ...
    invoke-virtual {v4, v0, v8}, Landroid/content/Context;->sendOrderedBroadcast(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    const-string v7, " , Action = UP , sendOrderedBroadcast:"
