...
.method public static declared-synchronized getNextImageFilePath(Landroid/app/Activity;Ljava/lang/String;)Lcom/android/camera/io/DCFPath;
    ...
    const-class v4, Lcom/android/camera/SnapboothFileManager;
    ...
    invoke-static {v5}, Lcom/android/camera/SnapboothFileManager;->initDirectoryAndFileIndex(Z)V
    ...
    invoke-static {v5, v6}, Lcom/android/camera/io/Path;->combine(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v5}, Lcom/android/camera/io/FileUtility;->createDirectory(Ljava/lang/String;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sput v5, Lcom/android/camera/SnapboothFileManager;->mCurrentFileIndex:I
    ...
    sput v5, Lcom/android/camera/SnapboothFileManager;->mCurrentDirIndex:I
    ...
    invoke-static {p1, v6}, Lcom/android/camera/io/Path;->combine(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v6, v7, v8, v9}, Lcom/android/camera/io/DCFUtility;->getFilePath(Lcom/android/camera/io/DCFInfo;Ljava/lang/String;Lcom/android/camera/io/FileCounter;Lcom/android/camera/io/FileCounter;Lcom/android/camera/io/FileFormat;)Ljava/lang/String;
    ...
    const-string v6, "getNextImageFilePath() - Cannot create directory \'"
    ...
    invoke-static {p1, v5}, Lcom/android/camera/LOG;->E(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v5, "SnapboothFileManager"

    const-string v6, "Cannot backup \'DCIM\' directory"
    ...
    const-string v6, "Cannot find available location for image saving"
    ...
    new-instance v6, Lcom/android/camera/io/FileCounter;

    sget v7, Lcom/android/camera/SnapboothFileManager;->mCurrentFileIndex:I

    invoke-direct {v6, v7}, Lcom/android/camera/io/FileCounter;-><init>(I)V

    sget-object v7, Lcom/android/camera/io/FileFormat;->Jpeg:Lcom/android/camera/io/FileFormat;

    invoke-static {v5, v6, v7}, Lcom/android/camera/io/DCFUtility;->getFileName(Lcom/android/camera/io/DCFInfo;Lcom/android/camera/io/FileCounter;Lcom/android/camera/io/FileFormat;)Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v5, v6, v7}, Lcom/android/camera/io/DCFPath;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/io/FileCounter;Lcom/android/camera/io/FileCounter;)V
    :try_end_2
...
.method public static declared-synchronized storeImage(Landroid/app/Activity;Ljava/lang/Object;)Z
    ...
    :cond_a
    :try_start_7
    const-string v2, "snapbooth_current_image_index"
    ...
    invoke-static {v0, v2, v3}, Lcom/android/camera/HTCCameraAdvanceSetting;->writePreference(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Object;)Z

    const-string v2, "snapbooth_current_dir_index"
