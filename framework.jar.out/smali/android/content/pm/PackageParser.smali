...
.method public static generatePackageInfo(Landroid/content/pm/PackageParser$Package;[IIJJ)Landroid/content/pm/PackageInfo;
    ...
    .line 224
    iget-object v11, p0, Landroid/content/pm/PackageParser$Package;->mHtcsdkVer:Ljava/lang/String;

    iput-object v11, v8, Landroid/content/pm/PackageInfo;->htcsdkVer:Ljava/lang/String;
...
.method private parsePackage(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    .line 865
    const-string v29, "android.uid.felicalock"
    ...
    .line 868
    const-string v29, "android.uid.felica.testtool"
    ...
    .line 874
    .local v22, nameError:Ljava/lang/String;
    if-eqz v22, :cond_6
    ...
    .end local v22           #nameError:Ljava/lang/String;
    :cond_7
    ...
    .local v32, supportsSmallScreens:I
    const/16 v31, 0x1
    ...
    .local v33, supportsXLargeScreens:I
    const/16 v27, 0x1

    .local v27, resizeable:I
    const/4 v11, 0x1
    ...
    .local v14, extraResPathList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    new-instance v15, Landroid/content/pm/FeatureInfo;

    invoke-direct {v15}, Landroid/content/pm/FeatureInfo;-><init>()V

    .local v15, fi:Landroid/content/pm/FeatureInfo;
    ...
    iput-object v3, v15, Landroid/content/pm/FeatureInfo;->name:Ljava/lang/String;

    iget-object v3, v15, Landroid/content/pm/FeatureInfo;->name:Ljava/lang/String;
    ...
    iput v3, v15, Landroid/content/pm/FeatureInfo;->reqGlEsVersion:I
    ...
    iget v3, v15, Landroid/content/pm/FeatureInfo;->flags:I

    or-int/lit8 v3, v3, 0x1

    iput v3, v15, Landroid/content/pm/FeatureInfo;->flags:I
    ...
    iget v3, v15, Landroid/content/pm/FeatureInfo;->reqGlEsVersion:I
    ...
    .end local v15           #fi:Landroid/content/pm/FeatureInfo;
    :cond_18
    ...
    .local v36, targetVers:I
    const/16 v35, 0x0

    .local v35, targetCode:Ljava/lang/String;
    const/4 v3, 0x0
    ...
    .local v38, val:Landroid/util/TypedValue;
    if-eqz v38, :cond_19
    ...
    .end local v35           #targetCode:Ljava/lang/String;
    .end local v36           #targetVers:I
    .end local v38           #val:Landroid/util/TypedValue;
    :cond_22
    :goto_6
    invoke-static/range {p2 .. p2}, Lcom/android/internal/util/XmlUtils;->skipCurrentTag(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .restart local v19       #minCode:Ljava/lang/String;
    .restart local v20       #minVers:I
    .restart local v35       #targetCode:Ljava/lang/String;
    .restart local v36       #targetVers:I
    .restart local v38       #val:Landroid/util/TypedValue;
    :cond_23
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .local v24, orig:Ljava/lang/String;
    ...
    .end local v24           #orig:Ljava/lang/String;
    :cond_2c
    ...
    :cond_33
    const-string v3, "restore-components"
    ...
    .local v17, implicitPerms:Ljava/lang/StringBuilder;
    const/16 v18, 0x0
    ...
    .local v23, npi:Landroid/content/pm/PackageParser$NewPermissionInfo;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .end local v23           #npi:Landroid/content/pm/PackageParser$NewPermissionInfo;
    :cond_3b
    if-eqz v17, :cond_3c
    ...
    .restart local v23       #npi:Landroid/content/pm/PackageParser$NewPermissionInfo;
    :cond_48
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->requestedPermissions:Ljava/util/ArrayList;
    ...
    .end local v17           #implicitPerms:Ljava/lang/StringBuilder;
    const/16 v3, 0x80
    ...
    .restart local v17       #implicitPerms:Ljava/lang/StringBuilder;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;
