...
.method private selectedActivityNotAvailable(Landroid/content/Intent;Ljava/lang/Exception;)V
    ...
    const-string/jumbo v3, "resolve_activity_warning_app_not_available"
...
.method protected onCreate(Landroid/os/Bundle;Landroid/content/Intent;Ljava/lang/CharSequence;[Landroid/content/Intent;Ljava/util/List;Z)V
    ...
    iput-object v1, v0, Lcom/android/internal/app/ResolverActivity;->mPm:Landroid/content/pm/PackageManager;
    ...
    iget-object v7, v0, Lcom/android/internal/app/AlertActivity;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;
    ...
    iput-object v0, v7, Lcom/android/internal/app/AlertController$AlertParams;->mOnClickListener:Landroid/content/DialogInterface$OnClickListener;

    .line 111
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/internal/app/ResolverActivity;->mPackageMonitor:Lcom/android/internal/content/PackageMonitor;

    const/4 v2, 0x0

    move-object/from16 v0, p0

    invoke-virtual {v1, v0, v2}, Lcom/android/internal/content/PackageMonitor;->register(Landroid/content/Context;Z)V
    ...
    iput-object v1, v0, Lcom/android/internal/app/ResolverActivity;->mAlwaysCheck:Landroid/widget/CheckBox;

    .line 118
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/internal/app/ResolverActivity;->mAlwaysCheck:Landroid/widget/CheckBox;
    ...
    iget-object v14, v8, Landroid/content/res/Configuration;->skin:Ljava/lang/String;

    .line 126
    .local v14, skinPackage:Ljava/lang/String;
    if-eqz v14, :cond_0
    ...
    invoke-virtual {v1, v14}, Landroid/content/pm/PackageManager;->getResourcesForApplication(Ljava/lang/String;)Landroid/content/res/Resources;

    move-result-object v15

    .line 129
    .local v15, themeres:Landroid/content/res/Resources;
    const-string v1, "btn_check_holo_dark"

    const-string v2, "drawable"

    invoke-virtual {v15, v1, v2, v14}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .end local v14           #skinPackage:Ljava/lang/String;
    .end local v15           #themeres:Landroid/content/res/Resources;
    :cond_0
    :goto_0
    iget-object v1, v7, Lcom/android/internal/app/AlertController$AlertParams;->mView:Landroid/view/View;
    ...
    iput-object v1, v0, Lcom/android/internal/app/ResolverActivity;->mClearDefaultHint:Landroid/widget/TextView;

    .line 139
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/internal/app/ResolverActivity;->mClearDefaultHint:Landroid/widget/TextView;
    ...
    iput-object v1, v0, Lcom/android/internal/app/ResolverActivity;->mAdapter:Lcom/android/internal/app/ResolverActivity$ResolveListAdapter;
    ...
    invoke-direct {v0, v1, v11}, Lcom/android/internal/app/ResolverActivity;->selectedActivityNotAvailable(Landroid/content/Intent;Ljava/lang/Exception;)V
    ...
    .restart local v14       #skinPackage:Ljava/lang/String;
    :catch_1
    move-exception v1
