...
.method constructor <init>(Lcom/htc/server/HtcHALAmsListener;Ljava/lang/String;)V
    ...
    .line 118
    iput-boolean v1, p0, Lcom/htc/server/HtcHALAmsListener$StatusUpdateThread;->mbIsNaviMode:Z
...
.method private updateNaviMode(Ljava/lang/String;)V
    .locals 6
    .parameter "activityString"
    ...
    .line 122
    .local v2, newMode:Z
    const-string v3, "com.google.android.maps.driveabout.app.NavigationActivity"
    ...
    .line 124
    :cond_0
    iget-boolean v3, p0, Lcom/htc/server/HtcHALAmsListener$StatusUpdateThread;->mbIsNaviMode:Z

    if-eq v3, v2, :cond_1

    .line 125
    iput-boolean v2, p0, Lcom/htc/server/HtcHALAmsListener$StatusUpdateThread;->mbIsNaviMode:Z

    .line 127
    :try_start_0
    iget-object v4, p0, Lcom/htc/server/HtcHALAmsListener$StatusUpdateThread;->mHwService:Landroid/os/IHtcHardwareService;
    ...
    :goto_0
    invoke-interface {v4, v3}, Landroid/os/IHtcHardwareService;->setNaviMode(I)I
    ...
    const-string v5, "Unable to notify NaviMode change, errno = "
    ...
    const-string v5, "NaviMode = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/htc/server/HtcHALAmsListener$StatusUpdateThread;->mbIsNaviMode:Z
    ...
    const-string v5, "Unable to notify NaviMode change"
