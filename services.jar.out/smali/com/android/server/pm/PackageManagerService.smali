...
.field private static final FM_RADIO_UID:I = 0x405
...
.field static final SCAN_RESTORE_COMPONENTS:I = -0x80000000
...
.field static final SKETCHER_BLACKLIST_PATH:Ljava/lang/String; = "/system/etc/sketcher_blacklist"

.field static final SKETCHER_BLACKLIST_TABLE:[Ljava/lang/String; = null

.field private static final SMARTCARD_UID:I = 0x2703
...
.field private static mAppNameCache:Ljava/util/HashMap; = null
...
.field private mHTCFotaApps:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private mHtcAppDirectedSMS:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private mHtcSignature:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field mSketcherBlackList:Ljava/util/Properties;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/pm/PackageManagerService;->mAppNameCache:Ljava/util/HashMap;
    ...
    const-string v2, "com.zoodles.kidmode.htc"

    aput-object v2, v0, v1

    const/4 v1, 0x1

    const-string v2, "com.newspaperdirect.pressreader.android"

    aput-object v2, v0, v1

    const/4 v1, 0x2

    const-string v2, "com.zinio.mobile.android"
    ...
    const-string v2, "com.she.hami.atom"
    ...
    const-string v2, "com.sdgtl.watch.flyer"

    aput-object v2, v0, v1

    sput-object v0, Lcom/android/server/pm/PackageManagerService;->SKETCHER_BLACKLIST_TABLE:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;ZZ)V
    ...
    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mHtcAppDirectedSMS:Ljava/util/HashMap;
    ...
    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mHTCFotaApps:Ljava/util/List;
    ...
    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mHtcSignature:Ljava/util/List;
    ...
    const-string v3, "android.uid.felicalock"
    ...
    const-string v3, "android.uid.felica.testtool"
    ...
    const-string v3, "android.uid.drm"
    ...
    const-string v3, "android.uid.graphics"
    ...
    const-string v3, "com.htc.rosie.uid.shared"
    ...
    const-string v3, "com.htc.album.uid"
    ...
    const-string v3, "com.htc.album.uid.shared"
    ...
    const-string v3, "com.htc.mail.uid"
    ...
    const-string v3, "com.htc.notes.uid"
    ...
    const-string v3, "com.htc.ereader.uid.shared"
    ...
    const-string v3, "com.htc.googlereader.uid"
    ...
    const-string v3, "com.htc.sketchbook.uid"
    ...
    invoke-static {v9, v2}, Lcom/android/server/pm/PackageManagerService;->splitString(Ljava/lang/String;C)[Ljava/lang/String;
    ...
    :try_start_6
    invoke-static/range {v24 .. v24}, Ldalvik/system/DexFile;->isDexOptNeeded(Ljava/lang/String;)Z
    ...
    const-string v3, "/framework-htc-res.apk"
    ...
    const-string v3, "/com.htc.resources.apk"
    ...
    :cond_d
    :try_start_8
    invoke-static/range {v30 .. v30}, Ldalvik/system/DexFile;->isDexOptNeeded(Ljava/lang/String;)Z
    ...
    const-string v2, "system/fotaBoot"
    ...
    check-cast v33, Lcom/android/server/pm/PackageSetting;
    ...
    const-string v2, "com.htc.android.iqagent"
    ...
    const-string v2, "com.htc.android.iqrd"
    ...
    :cond_14
    const-string v28, "System package xxx no longer exists; wiping its data"
    ...
    :goto_b
    :try_start_b
    const-string v2, "service.fota.load.customization"

    const-string v3, "fota.load.customization"
    ...
    invoke-static {v2}, Lcom/htc/htcjavaflag/NonHTCAPList;->isNonHTCAP(Ljava/lang/String;)Z
    ...
    iput-boolean v3, v2, Landroid/content/pm/ApplicationInfo;->hasHtcSignature:Z
    ...
    iget-object v8, v2, Landroid/content/pm/PackageParser$Package;->mSignatures:[Landroid/content/pm/Signature;
    ...
    iget-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mHtcSignature:Ljava/util/List;
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/content/pm/Signature;->hashCode()I

    move-result v2

    invoke-virtual/range {v19 .. v19}, Landroid/content/pm/Signature;->hashCode()I
    ...
    iput-boolean v0, v2, Landroid/content/pm/ApplicationInfo;->hasHtcSignature:Z
    ...
    iget-object v2, v2, Lcom/android/server/pm/Settings;->mHidedSysPkgs:Ljava/util/ArrayList;
    ...
    iget-boolean v2, v2, Lcom/android/server/pm/Settings;->mSysPkgsInitXml:Z

    if-nez v2, :cond_20

    const-string v2, "PackageManager"

    const-string v3, "Read Hided system packages from default.xml in customize"

    invoke-static {v2, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/pm/PackageManagerService;->readHidedSysPkgsFromXml()V

    :cond_20
    const-string v2, "PackageManager"

    const-string v3, "Pre-process Hided System Packages..."

    invoke-static {v2, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct/range {p0 .. p0}, Lcom/android/server/pm/PackageManagerService;->preHidedSysPkgs()V

    sget-boolean v2, Lcom/htc/htcjavaflag/HtcBuildFlag;->HTC_FEATURE_3LM:Z

    if-eqz v2, :cond_21

    invoke-direct/range {p0 .. p0}, Lcom/android/server/pm/PackageManagerService;->mountTmpfs()V
...
.method private chooseBestActivity(Landroid/content/Intent;Ljava/lang/String;ILjava/util/List;)Landroid/content/pm/ResolveInfo;
    ...
    :cond_2
    const-string v16, "com.htc.HtcLinkifyDispatcher"

    const-string v10, "com.htc.HtcLinkifyDispatcher.HtcLinkifyDispatcherActivity"
    ...
    iget-object v1, v15, Landroid/content/pm/PackageParser$Package;->activities:Ljava/util/ArrayList;
    ...
    invoke-static {v9, v1}, Landroid/content/pm/PackageParser;->generateActivityInfo(Landroid/content/pm/PackageParser$Activity;I)Landroid/content/pm/ActivityInfo;
    ...
    const-string v2, "Failed get preferred activity for Settings!"
    ...
    iget v1, v0, Landroid/content/pm/ResolveInfo;->preferredOrder:I
    ...
    iget-boolean v1, v0, Landroid/content/pm/ResolveInfo;->isDefault:Z

    move-object/from16 v0, v18

    iget-boolean v2, v0, Landroid/content/pm/ResolveInfo;->isDefault:Z
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/android/server/pm/PackageManagerService;->findPreferredActivity(Landroid/content/Intent;Ljava/lang/String;ILjava/util/List;I)Landroid/content/pm/ResolveInfo;
...
.method private containHidedSysPkgs(Ljava/lang/String;)Z
    .locals 2
    ...
    iget-boolean v1, v1, Lcom/android/server/pm/Settings;->mSysPkgsInit:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/server/pm/PackageManagerService;->mSettings:Lcom/android/server/pm/Settings;

    iget-object v1, v1, Lcom/android/server/pm/Settings;->mHidedSysPkgsMod:Ljava/util/ArrayList;
    ...
    iget-object v1, v1, Lcom/android/server/pm/Settings;->mHidedSysPkgs:Ljava/util/ArrayList;
...
.method private createTempPackageFile(Ljava/io/File;)Ljava/io/File;
    ...
    const-string v9, "Couldn\'t create temp file for downloaded package file. Dir:"
    ...
    const-string v8, "Trouble getting the canoncical path for a temp file."
...
.method private generatePackageInfoFromSettingsLPw(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    const-string v3, "Failed to generate PackageInfo, PackageSettings is null! pkg:"
...
.method private getPackageSizeInfoLI(Ljava/lang/String;Landroid/content/pm/PackageStats;)Z
    ...
    iget-object v0, v9, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v6, v9, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    const-string v2, "Failed to get Sd File Path !"
    ...
    iget-object v2, v9, Landroid/content/pm/PackageParser$Package;->mPath:Ljava/lang/String;
...
.method private installNewPackageLI(Landroid/content/pm/PackageParser$Package;IILjava/lang/String;Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;)V
    ...
    iput-boolean v1, v0, Landroid/content/pm/ApplicationInfo;->htcApp:Z

    iget-object v0, p0, Lcom/android/server/pm/PackageManagerService;->mHTCFotaApps:Ljava/util/List;
    ...
    const-string v1, "Package installer name change"
    ...
    :cond_7
    const-string v0, "HTCFotaAppInstaller"
    ...
    :cond_8
    invoke-virtual {p0}, Lcom/android/server/pm/PackageManagerService;->ensureSketcherBlackListLoaded()V

    iget-object v1, p1, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    const-string v0, "1"

    iget-object v2, p0, Lcom/android/server/pm/PackageManagerService;->mSketcherBlackList:Ljava/util/Properties;
    ...
    :goto_2
    iput-boolean v0, v1, Landroid/content/pm/ApplicationInfo;->disableSketcher:Z
...
.method private installPackageLI(Lcom/android/server/pm/PackageManagerService$InstallArgs;ZLcom/android/server/pm/PackageManagerService$PackageInstalledInfo;)V
    ...
    const-string v7, "clear PackageParser.PARSE_CHATTY"
...
.method private mountTmpfs()V
    ...
    invoke-virtual {p0, v7, v3}, Lcom/android/server/pm/PackageManagerService;->getInstalledPackages(ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;

    move-result-object v6

    sget-object v7, Landroid/content/pm/PackageInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v6, v4, v7}, Landroid/content/pm/ParceledListSlice;->populateList(Ljava/util/List;Landroid/os/Parcelable$Creator;)Landroid/os/Parcelable;

    move-result-object v2

    check-cast v2, Landroid/content/pm/PackageInfo;

    invoke-virtual {v6}, Landroid/content/pm/ParceledListSlice;->isLastSlice()Z
    ...
    invoke-virtual {v1, v7}, Landroid/security/KeyStore;->contains(Ljava/lang/String;)Z
    ...
    invoke-virtual {v7, v8, v9, v10}, Lcom/android/server/pm/Installer;->overlayTmpfs(Ljava/lang/String;II)I
...
.method private preHidedSysPkgs()V
    .locals 6

    iget-object v3, p0, Lcom/android/server/pm/PackageManagerService;->mSettings:Lcom/android/server/pm/Settings;

    iget-object v3, v3, Lcom/android/server/pm/Settings;->mHidedSysPkgs:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/pm/PackageManagerService;->getPackageUid(Ljava/lang/String;)I
    ...
    const-string v5, "Cust_Global_hide_AP_List : idx = "
    ...
    const-string v5, " does not exist in device!"
    ...
    const-string v5, "(Disabled)pre-Processing hide SysPkg : "
    ...
    invoke-direct {p0, v2, v3, v4, v5}, Lcom/android/server/pm/PackageManagerService;->setHideAppEnabledSetting(Ljava/lang/String;Ljava/lang/String;II)V
...
.method private putCachedAppName(Ljava/lang/String;Ljava/lang/String;)V
    .locals 1

    sget-object v0, Lcom/android/server/pm/PackageManagerService;->mAppNameCache:Ljava/util/HashMap;
...
.method private removePackageDataLI(Landroid/content/pm/PackageParser$Package;Lcom/android/server/pm/PackageManagerService$PackageRemovedInfo;IZ)V
    ...
    iput-object v0, p2, Lcom/android/server/pm/PackageManagerService$PackageRemovedInfo;->removedPackageName:Ljava/lang/String;
...
.method private replaceNonSystemPackageLI(Landroid/content/pm/PackageParser$Package;Landroid/content/pm/PackageParser$Package;IILjava/lang/String;Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;)V
    ...
    iput-boolean v6, v4, Landroid/content/pm/ApplicationInfo;->htcApp:Z

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/pm/PackageManagerService;->mHTCFotaApps:Ljava/util/List;
    ...
    const-string v6, "Package installer name change."
    ...
    :cond_6
    const-string v4, "HTCFotaAppInstaller"
    ...
    :cond_7
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/pm/PackageManagerService;->ensureSketcherBlackListLoaded()V
    ...
    iget-object v10, v0, Lcom/android/server/pm/PackageManagerService;->mSketcherBlackList:Ljava/util/Properties;
    ...
    :goto_3
    iput-boolean v4, v6, Landroid/content/pm/ApplicationInfo;->disableSketcher:Z
...
.method private replaceSystemPackageLI(Landroid/content/pm/PackageParser$Package;Landroid/content/pm/PackageParser$Package;IILjava/lang/String;Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;)V
    ...
    iput-object v3, v2, Lcom/android/server/pm/PackageManagerService$PackageRemovedInfo;->removedPackageName:Ljava/lang/String;
    ...
    iput-boolean v3, v2, Landroid/content/pm/ApplicationInfo;->htcApp:Z

    iget-object v2, p0, Lcom/android/server/pm/PackageManagerService;->mHTCFotaApps:Ljava/util/List;
    ...
    const-string v3, "Package installer name change ."
    ...
    :cond_b
    const-string v2, "HTCFotaAppInstaller"
...
.method private scanPackageLI(Landroid/content/pm/PackageParser$Package;IIJ)Landroid/content/pm/PackageParser$Package;
    ...
    new-instance v57, Ljava/io/File;
    ...
    iget-object v12, v0, Lcom/android/server/pm/PackageManagerService;->mScanningPath:Ljava/io/File;
    ...
    iget-object v12, v0, Lcom/android/server/pm/PackageManagerService;->mResolveActivity:Landroid/content/pm/ActivityInfo;

    iget-object v12, v12, Landroid/content/pm/ComponentInfo;->name:Ljava/lang/String;

    invoke-direct {v3, v10, v12}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v14, v0, Lcom/android/server/pm/PackageManagerService;->mPackages:Ljava/util/HashMap;
    ...
    invoke-static {v3, v4, v10, v12, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-virtual {v3, v4, v10, v12}, Lcom/android/server/pm/Settings;->getSharedUserLPw(Ljava/lang/String;IZ)Lcom/android/server/pm/SharedUserSetting;
    ...
    iget-object v3, v0, Landroid/content/pm/PackageParser$Package;->mRestoreComponents:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageSetting;->restoreComponentLPw(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageSetting;->enableComponentLPw(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageSetting;->disableComponentLPw(Ljava/lang/String;)Z
    ...
    check-cast v45, Landroid/content/pm/PackageParser$Provider;
    ...
    check-cast v44, Landroid/content/pm/PackageParser$Provider;
    ...
    invoke-virtual/range {v44 .. v44}, Landroid/content/pm/PackageParser$Provider;->getComponentName()Landroid/content/ComponentName;
    ...
    invoke-virtual/range {v57 .. v57}, Ljava/io/File;->lastModified()J
    ...
    invoke-static {v4, v10, v12}, Lcom/android/server/pm/PackageManagerService;->fixProcessName(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static/range {v39 .. v39}, Lcom/android/internal/content/NativeLibraryHelper;->removeNativeBinariesFromDirLI(Ljava/io/File;)Z
    ...
    iget-boolean v0, v0, Landroid/content/pm/PackageParser$Package;->mSkipErased:Z
    ...
    iget-object v10, v0, Lcom/android/server/pm/PackageManagerService;->mInstaller:Lcom/android/server/pm/Installer;
    ...
    invoke-virtual/range {v10 .. v15}, Lcom/android/server/pm/Installer;->chown(Ljava/lang/String;IIII)I
    ...
    const-string v10, " skipErased true"
    ...
    invoke-virtual {v3, v11, v4}, Lcom/android/server/pm/Installer;->remove(Ljava/lang/String;I)I
    ...
    invoke-virtual {v3, v11}, Lcom/android/server/pm/UserManager;->removePackageForAllUsers(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v11, v4, v10}, Lcom/android/server/pm/Installer;->install(Ljava/lang/String;II)I
    ...
    invoke-virtual {v3, v11, v4}, Lcom/android/server/pm/UserManager;->installPackageForAllUsers(Ljava/lang/String;I)V
    ...
    iget-wide v12, v0, Lcom/android/server/pm/PackageSettingBase;->firstInstallTime:J
    ...
    iget-object v12, v12, Landroid/content/pm/ProviderInfo;->processName:Ljava/lang/String;
    ...
    invoke-static {v10, v12, v13}, Lcom/android/server/pm/PackageManagerService;->fixProcessName(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v13, v0, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;
    ...
    new-instance v45, Landroid/content/pm/PackageParser$Provider;

    invoke-direct/range {v45 .. v46}, Landroid/content/pm/PackageParser$Provider;-><init>(Landroid/content/pm/PackageParser$Provider;)V
    ...
    iget-wide v12, v0, Lcom/android/server/pm/PackageSettingBase;->timeStamp:J
    ...
    check-cast v56, Landroid/content/pm/PackageParser$Service;
    ...
    iget-object v12, v0, Landroid/content/pm/PackageParser$Service;->info:Landroid/content/pm/ServiceInfo;
    ...
    iget-object v12, v0, Landroid/content/pm/PackageParser$Activity;->info:Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v3, v0, v10}, Lcom/android/server/pm/PackageManagerService$ActivityIntentResolver;->addActivity(Landroid/content/pm/PackageParser$Activity;Ljava/lang/String;)V
    ...
    check-cast v49, Landroid/content/pm/PackageParser$PermissionGroup;
    ...
    check-cast v24, Landroid/content/pm/PackageParser$PermissionGroup;
    ...
    iget-object v12, v0, Landroid/content/pm/PackageParser$PermissionGroup;->info:Landroid/content/pm/PermissionGroupInfo;
    ...
    iget-object v12, v12, Landroid/content/pm/PermissionGroupInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v10, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    const-string v12, " ignored: original from "
    ...
    check-cast v45, Landroid/content/pm/PackageParser$Permission;
    ...
    check-cast v22, Lcom/android/server/pm/BasePermission;

    if-nez v22, :cond_61

    new-instance v22, Lcom/android/server/pm/BasePermission;
    ...
    invoke-direct {v0, v3, v10, v12}, Lcom/android/server/pm/BasePermission;-><init>(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iget-object v12, v0, Landroid/content/pm/PackageParser$Permission;->info:Landroid/content/pm/PermissionInfo;
    ...
    const-string v12, " ignored: base tree "
    ...
    const-string v12, " is from package "
    ...
    iget-object v12, v0, Lcom/android/server/pm/BasePermission;->sourcePackage:Ljava/lang/String;
    ...
    const-string v12, " ignored: no group "
    ...
    iget-object v12, v0, Landroid/content/pm/PackageParser$Permission;->group:Landroid/content/pm/PackageParser$PermissionGroup;
    ...
    iget-object v3, v0, Landroid/content/pm/PackageParser$Instrumentation;->info:Landroid/content/pm/InstrumentationInfo;
    ...
    invoke-static {v3}, Lcom/htc/htcjavaflag/NonHTCAPList;->isNonHTCAP(Ljava/lang/String;)Z
    ...
    iget-object v10, v0, Lcom/android/server/pm/PackageSettingBase;->installerPackageName:Ljava/lang/String;
    ...
    :goto_2f
    iput-boolean v3, v4, Landroid/content/pm/ApplicationInfo;->htcApp:Z
    ...
    const-string v3, "DirtyInstaller"
    ...
    :goto_30
    iput-boolean v3, v4, Landroid/content/pm/ApplicationInfo;->gmsApp:Z
    ...
    iput-boolean v4, v3, Landroid/content/pm/ApplicationInfo;->isDirty:Z

    const-string v3, "HTCFotaAppInstaller"
    ...
    iget-object v3, v0, Lcom/android/server/pm/PackageManagerService;->mHTCFotaApps:Ljava/util/List;
    ...
    aget-object v51, v21, v32

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/pm/PackageManagerService;->mHtcSignature:Ljava/util/List;
    ...
    const-string v4, "error is saving htc signature"
    ...
    invoke-virtual {v10, v12, v13}, Ljava/util/Properties;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_32
    iput-boolean v3, v4, Landroid/content/pm/ApplicationInfo;->disableSketcher:Z
    ...
    iget-object v0, v3, Landroid/content/pm/ApplicationInfo;->className:Ljava/lang/String;

    move-object/from16 v19, v0

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/pm/PackageManagerService;->mHtcAppDirectedSMS:Ljava/util/HashMap;
...
.method private setEnabledSetting(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    const-string v17, " setEnabledSetting(), pkgName="
    ...
    sget-boolean v15, Lcom/htc/htcjavaflag/HtcBuildFlag;->HTC_FEATURE_3LM:Z
...
.method private setHideAppEnabledSetting(Ljava/lang/String;Ljava/lang/String;II)V
    .locals 20
    ...
    const-string v17, " setHideAppEnabledSetting(), pkgName="
...
.method private updateExternalMediaStatusInner(ZZ)V
    ...
    const-string v32, "No secure containers on sdcard"
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/pm/PackageManagerService;->loadMediaPackages(Ljava/util/HashMap;[ILjava/util/HashSet;)V
    ...
    :try_start_0
    new-instance v5, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;

    move-object/from16 v0, p0

    invoke-direct {v5, v0, v9}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;-><init>(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v33, " stale due to getSecureContainerPath is null"
    ...
    invoke-virtual {v13}, Ljava/lang/NullPointerException;->getStackTrace()[Ljava/lang/StackTraceElement;
    ...
    check-cast v6, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;
    ...
    :cond_6
    invoke-virtual {v6}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->getPackageName()Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->getCodePath()Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/pm/PackageManagerService;->unloadMediaPackages(Ljava/util/HashMap;[IZ)V
...
.method private updateSettingsLI(Landroid/content/pm/PackageParser$Package;Ljava/lang/String;Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;)V
    ...
    const-string v4, "[embedded] New package installed in "
...
.method public checkAppDirectedSmsExisted(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/android/server/pm/PackageManagerService;->mHtcAppDirectedSMS:Ljava/util/HashMap;
...
.method public enableDialerLauncher()V
    .locals 5

    :try_start_0
    new-instance v0, Landroid/content/ComponentName;

    const-string v3, "com.android.dialerLauncher"

    const-string v4, "com.android.dialerLauncher.DialerLauncher"
    ...
    invoke-virtual {p0, v0, v2, v3}, Lcom/android/server/pm/PackageManagerService;->setComponentEnabledSetting(Landroid/content/ComponentName;II)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Could not enable DialerLauncher"
...
.method ensureSketcherBlackListLoaded()V
    .locals 10

    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService;->mSketcherBlackList:Ljava/util/Properties;
    ...
    iput-object v7, p0, Lcom/android/server/pm/PackageManagerService;->mSketcherBlackList:Ljava/util/Properties;

    const-string v1, "1"

    sget-object v0, Lcom/android/server/pm/PackageManagerService;->SKETCHER_BLACKLIST_TABLE:[Ljava/lang/String;
    ...
    invoke-virtual {v7, v6, v8}, Ljava/util/Properties;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v9, "sketcher blacklist = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/server/pm/PackageManagerService;->mSketcherBlackList:Ljava/util/Properties;

    invoke-virtual {v9}, Ljava/util/Properties;->size()I
    ...
    const-string v7, "/system/etc/sketcher_blacklist"
    ...
    const-string v9, "final sketcher blacklist = "
    ...
    const-string v8, "There is no coustomized sketcher blacklist"
    ...
    const-string v8, "Load sketcher blacklist failed:"
...
.method generatePackageInfo(Landroid/content/pm/PackageParser$Package;I)Landroid/content/pm/PackageInfo;
    ...
    const-string v3, "Failed to generate PackageInfo, PackageSetting is null!, flags:"
...
.method public getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/PackageManagerService;->containHidedSysPkgs(Ljava/lang/String;)Z
...
.method public getCachedAppName(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/pm/PackageManagerService;->mAppNameCache:Ljava/util/HashMap;
...
.method public getDirectedSmsReceivers(Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v10, p0, Lcom/android/server/pm/PackageManagerService;->mHtcAppDirectedSMS:Ljava/util/HashMap;
    ...
    const-string v12, " is  already removed?"
    ...
    :cond_0
    iget-object v10, v8, Landroid/content/pm/PackageParser$Package;->receivers:Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Landroid/content/pm/PackageParser$Activity;->intents:Ljava/util/ArrayList;
    ...
    invoke-virtual {v10, v11}, Landroid/content/pm/PackageParser$ActivityIntentInfo;->hasAction(Ljava/lang/String;)Z
    ...
    iget-object v11, v1, Landroid/content/pm/PackageParser$Activity;->className:Ljava/lang/String;
    ...
    const-string v11, "There is no Directed SMS App existed!"
...
.method public getInstalledApplications(ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, v8}, Lcom/android/server/pm/PackageManagerService;->containHidedSysPkgs(Ljava/lang/String;)Z
    ...
    iget-boolean v10, v1, Landroid/content/pm/ApplicationInfo;->isSkinApk:Z
...
.method public getInstalledPackages(ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, v7}, Lcom/android/server/pm/PackageManagerService;->containHidedSysPkgs(Ljava/lang/String;)Z
    ...
    iget-boolean v10, v10, Landroid/content/pm/ApplicationInfo;->isSkinApk:Z
...
.method public getInstalledSkinPackages()Ljava/util/List;
    ...
    invoke-virtual {p0, v3, v1}, Lcom/android/server/pm/PackageManagerService;->generatePackageInfo(Landroid/content/pm/PackageParser$Package;I)Landroid/content/pm/PackageInfo;
    ...
    iget-boolean v5, v5, Landroid/content/pm/ApplicationInfo;->isSkinApk:Z
...
.method public getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    const-string v4, "Failed to get PackageInfo!, pkg:"
...
.method public readHidedSysPkgsFromXml()V
    .locals 17
    ...
    const-string v15, "customize/MNS/default.xml"
    ...
    invoke-interface {v11, v4}, Lorg/xmlpull/v1/XmlPullParser;->setInput(Ljava/io/Reader;)V

    const-string v14, "customization_form"
    ...
    const-string v16, "Couldn\'t find or open customize file "
    ...
    const-string v14, "applications_hide"
    ...
    const-string v16, "Cust_Global_hide_AP_List : idx = "
    ...
    iget-object v14, v14, Lcom/android/server/pm/Settings;->mHidedSysPkgs:Ljava/util/ArrayList;
    ...
    const-string v15, "Failed to add Hide system packages, there is no test in <item> tag"
    ...
    const-string v15, "Got execption parsing customize file for hided system packages."
...
.method removePackageLI(Landroid/content/pm/PackageParser$Package;Z)V
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/pm/PackageManagerService;->clearPackagePreferredActivitiesLPw(Ljava/lang/String;)Z
    ...
    iget-object v13, v0, Landroid/content/pm/PackageParser$Package;->mPath:Ljava/lang/String;

    if-eqz v13, :cond_0

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/pm/PackageManagerService;->mAppDirs:Ljava/util/HashMap;
    ...
    iget-object v13, v0, Lcom/android/server/pm/PackageManagerService;->mProvidersByComponent:Ljava/util/HashMap;
    ...
    iget-object v13, v10, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;
    ...
    iget-object v13, v0, Lcom/android/server/pm/PackageManagerService;->mProviders:Ljava/util/HashMap;
    ...
    iget-object v13, v0, Lcom/android/server/pm/PackageManagerService;->mServices:Lcom/android/server/pm/PackageManagerService$ServiceIntentResolver;

    invoke-virtual {v13, v12}, Lcom/android/server/pm/PackageManagerService$ServiceIntentResolver;->removeService(Landroid/content/pm/PackageParser$Service;)V
    ...
    iget-object v13, v0, Lcom/android/server/pm/PackageManagerService;->mReceivers:Lcom/android/server/pm/PackageManagerService$ActivityIntentResolver;

    const-string v15, "receiver"

    invoke-virtual {v13, v2, v15}, Lcom/android/server/pm/PackageManagerService$ActivityIntentResolver;->removeActivity(Landroid/content/pm/PackageParser$Activity;Ljava/lang/String;)V
    ...
    :goto_7
    iget-object v13, v2, Landroid/content/pm/PackageParser$Activity;->info:Landroid/content/pm/ActivityInfo;
    ...
    iget-object v13, v0, Landroid/content/pm/PackageParser$Package;->activities:Ljava/util/ArrayList;
    ...
    iget-object v13, v0, Lcom/android/server/pm/PackageManagerService;->mActivities:Lcom/android/server/pm/PackageManagerService$ActivityIntentResolver;
    ...
    iget-object v13, v13, Lcom/android/server/pm/Settings;->mPermissions:Ljava/util/HashMap;
    ...
    iget-object v13, v13, Lcom/android/server/pm/Settings;->mPermissionTrees:Ljava/util/HashMap;
    ...
    iget-object v13, v4, Lcom/android/server/pm/BasePermission;->perm:Landroid/content/pm/PackageParser$Permission;

    if-ne v13, v10, :cond_15

    const/4 v13, 0x0

    iput-object v13, v4, Lcom/android/server/pm/BasePermission;->perm:Landroid/content/pm/PackageParser$Permission;
    ...
    iget-object v13, v0, Lcom/android/server/pm/PackageManagerService;->mInstrumentation:Ljava/util/HashMap;

    invoke-virtual {v2}, Landroid/content/pm/PackageParser$Instrumentation;->getComponentName()Landroid/content/ComponentName;
    ...
    :goto_d
    iget-object v13, v2, Landroid/content/pm/PackageParser$Instrumentation;->info:Landroid/content/pm/InstrumentationInfo;
    ...
    iget-object v13, v0, Lcom/android/server/pm/PackageManagerService;->mHtcAppDirectedSMS:Ljava/util/HashMap;
    ...
    iget-object v13, v13, Landroid/content/pm/ApplicationInfo;->className:Ljava/lang/String;
...
.method public setAppName(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "set new App name Fail!, the package name is null"
    ...
    const-string v9, " setAppName(), pkgName="
    ...
    const-string v8, "android.permission.DYNAMIC_SET_APP_NAME"
    ...
    const-string v9, "Permission Denial: attempt to change app name from pid="
    ...
    invoke-virtual {p0, p1, v6}, Lcom/android/server/pm/PackageManagerService;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    const-string v8, "Failure to set New Application name dynamically."
    ...
    :cond_4
    invoke-direct {p0, p1, p2}, Lcom/android/server/pm/PackageManagerService;->putCachedAppName(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/pm/PackageManagerService;->mPendingBroadcasts:Ljava/util/HashMap;
    ...
    invoke-virtual {v6, v8, v9, v10}, Lcom/android/server/pm/PackageManagerService$PackageHandler;->sendEmptyMessageDelayed(IJ)Z
...
.method public setEnabledSettingEx([Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string v9, "setEnabledSettingEx, enabledPkgs:"
    ...
    const-string v8, "Failed dynamic set package state ! Both Packages are null"
    ...
    iput-boolean v8, v7, Lcom/android/server/pm/Settings;->mSysPkgsInit:Z
    ...
    iput-object v8, v7, Lcom/android/server/pm/Settings;->mHidedSysPkgsMod:Ljava/util/ArrayList;

    const-string v7, "PackageManager"

    const-string v8, "Send hide system packages status to disabled"
    ...
    iget-object v7, v7, Lcom/android/server/pm/Settings;->mHidedSysPkgsMod:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/pm/PackageManagerService;->getPackageUid(Ljava/lang/String;)I
    ...
    const-string v9, "Failed to disabled hide System package: "
    ...
    const-string v9, "(Disabled)Processing hide SysPkg : "
    ...
    invoke-direct {p0, v6, v7, v8, v9}, Lcom/android/server/pm/PackageManagerService;->setHideAppEnabledSetting(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    const-string v8, "Send hide system packages fake remove intent"
    ...
    const-string v9, "(Remove)Processing hide SysPkg : "
    ...
    invoke-static {v7, v6, v4, v8, v9}, Lcom/android/server/pm/PackageManagerService;->sendPackageBroadcast(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;Landroid/content/IIntentReceiver;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v8, "Failed to Disabled Hided System Packages, diabled Pkgs is null !"
    ...
    const-string v8, "Send hide system packages status to enabled"
    ...
    const-string v9, "Failed to enabled hide System package: "
    ...
    const-string v9, "(Enabled)Processing hide SysPkg : "
    ...
    const-string v9, "(Added)Processing hide SysPkg : "
    ...
    const-string v8, "Failed to Enabled Hided System Packages, Enabled Pkgs is null !"
...
.method public systemReady()V
    ...
    const-string v2, "enable Dialer Launcher..."

    invoke-static {v1, v2}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0}, Lcom/android/server/pm/PackageManagerService;->enableDialerLauncher()V
