...
.method constructor <init>()V
    ...
    iput-object v2, p0, Lcom/android/server/pm/Settings;->mCwApps:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Lcom/android/server/pm/Settings;->mUpdatedDataPreloadApps:Ljava/util/HashMap;
...
.method dumpPackagesLPr(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/android/server/pm/PackageManagerService$DumpState;)V
    ...
    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->realName:Ljava/lang/String;
    ...
    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->name:Ljava/lang/String;
    ...
    .line 2223
    iget-object v10, v7, Lcom/android/server/pm/PackageSetting;->sharedUser:Lcom/android/server/pm/SharedUserSetting;

    invoke-virtual {p3, v10}, Lcom/android/server/pm/PackageManagerService$DumpState;->setSharedUser(Lcom/android/server/pm/SharedUserSetting;)V
    ...
    iget v10, v7, Lcom/android/server/pm/PackageSetting;->userId:I
    ...
    iget-object v10, v7, Lcom/android/server/pm/GrantedPermissions;->gids:[I
    ...
    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->codePathString:Ljava/lang/String;
    ...
    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->resourcePathString:Ljava/lang/String;

    invoke-virtual {p1, v10}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2249
    const-string v10, "    nativeLibraryPath="

    invoke-virtual {p1, v10}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->nativeLibraryPathString:Ljava/lang/String;
    ...
    iget v10, v7, Lcom/android/server/pm/PackageSettingBase;->versionCode:I
    ...
    .line 2299
    iget-wide v10, v7, Lcom/android/server/pm/PackageSettingBase;->timeStamp:J
    ...
    .line 2302
    iget-wide v10, v7, Lcom/android/server/pm/PackageSettingBase;->firstInstallTime:J
    ...
    .line 2305
    iget-wide v10, v7, Lcom/android/server/pm/PackageSettingBase;->lastUpdateTime:J
    ...
    .line 2307
    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->installerPackageName:Ljava/lang/String;
    ...
    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->signatures:Lcom/android/server/pm/PackageSignatures;
    ...
    iget-boolean v10, v7, Lcom/android/server/pm/PackageSettingBase;->permissionsFixed:Z
    ...
    iget-boolean v10, v7, Lcom/android/server/pm/PackageSettingBase;->haveGids:Z

    invoke-virtual {p1, v10}, Ljava/io/PrintWriter;->println(Z)V

    .line 2313
    const-string v10, "    pkgFlags=0x"

    invoke-virtual {p1, v10}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v10, v7, Lcom/android/server/pm/GrantedPermissions;->pkgFlags:I
    ...
    iget v10, v7, Lcom/android/server/pm/PackageSettingBase;->installStatus:I
    ...
    iget-boolean v10, v7, Lcom/android/server/pm/PackageSettingBase;->stopped:Z
    ...
    iget v10, v7, Lcom/android/server/pm/PackageSettingBase;->enabled:I

    invoke-virtual {p1, v10}, Ljava/io/PrintWriter;->println(I)V

    .line 2317
    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->disabledComponents:Ljava/util/HashSet;
    ...
    .line 2323
    :cond_15
    iget-object v10, v7, Lcom/android/server/pm/PackageSettingBase;->enabledComponents:Ljava/util/HashSet;
    ...
    const-string v11, "    isHTC="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-boolean v11, v5, Landroid/content/pm/ApplicationInfo;->htcApp:Z

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v10

    const-string v11, " isGMS="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-boolean v11, v5, Landroid/content/pm/ApplicationInfo;->gmsApp:Z
    ...
    iget-boolean v11, v5, Landroid/content/pm/ApplicationInfo;->isDirty:Z
    ...
    :cond_17
    iget-object v10, v7, Lcom/android/server/pm/GrantedPermissions;->grantedPermissions:Ljava/util/HashSet;
    ...
    .line 2347
    iget-object v10, p0, Lcom/android/server/pm/Settings;->mRenamedPackages:Ljava/util/HashMap;
    ...
    .line 2356
    :cond_1b
    const-string v10, "Renamed packages:"
    ...
    .line 2367
    iget-object v10, p0, Lcom/android/server/pm/Settings;->mDisabledSysPackages:Ljava/util/HashMap;
    ...
    .line 2376
    :cond_20
    const-string v10, "Hidden system packages:"
...
.method readLPw()Z
    ...
    .line 1386
    :cond_14
    const-string v2, "preload-packages"
    ...
    .line 1388
    :cond_15
    const-string v2, "updated-preload-packages"
...
.method removePackageLPw(Ljava/lang/String;)I
    ...
    const-string v8, "removePackageLP(), pkgName="
    ...
    .line 600
    iget-object v6, v4, Lcom/android/server/pm/PackageSetting;->sharedUser:Lcom/android/server/pm/SharedUserSetting;
    ...
    iget-object v6, v6, Lcom/android/server/pm/SharedUserSetting;->packages:Ljava/util/HashSet;
    ...
    .line 603
    iget-object v6, p0, Lcom/android/server/pm/Settings;->mSharedUsers:Ljava/util/HashMap;
    ...
    iget v6, v6, Lcom/android/server/pm/SharedUserSetting;->userId:I

    invoke-direct {p0, v6}, Lcom/android/server/pm/Settings;->removeUserIdLPw(I)V
    ...
    .line 608
    :cond_2
    iget v6, v4, Lcom/android/server/pm/PackageSetting;->userId:I
...
.method writeLPr()V
    ...
    const-string v25, "preload-packages"
    ...
    const-string v25, "updated-preload-packages"
    ...
    .line 1001
    .restart local v9       #e:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;"
    const/16 v24, 0x0
