...
.field private static final privilegedHtcPackage:Ljava/lang/String; = "com.htc.backup"
...
.method bindToAgentSynchronous(Landroid/content/pm/ApplicationInfo;I)Landroid/app/IBackupAgent;
    ...
    const-string v8, "AP\'s backupAgent is null, app:"
...
.method public fullBackupPrivileged(Landroid/os/ParcelFileDescriptor;ZZZZ[Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    const-string v2, "com.htc.backup"
    ...
    invoke-virtual {v2, v10}, Lcom/android/server/BackupManagerService$BackupHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    const-string v3, "Calling package name not allowed."
...
.method public fullRestorePrivileged(Landroid/os/ParcelFileDescriptor;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    .line 4946
    new-instance v2, Lcom/android/server/BackupManagerService$FullRestoreParams;

    invoke-direct {v2, p0, p1}, Lcom/android/server/BackupManagerService$FullRestoreParams;-><init>(Lcom/android/server/BackupManagerService;Landroid/os/ParcelFileDescriptor;)V

    .line 4947
    .local v2, params:Lcom/android/server/BackupManagerService$FullRestoreParams;
    iput-object p2, v2, Lcom/android/server/BackupManagerService$FullParams;->observer:Landroid/app/backup/IFullBackupRestoreObserver;

    .line 4948
    const-string v3, ""

    iput-object v3, v2, Lcom/android/server/BackupManagerService$FullParams;->curPassword:Ljava/lang/String;

    .line 4949
    const-string v3, ""

    iput-object v3, v2, Lcom/android/server/BackupManagerService$FullParams;->encryptPassword:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v2}, Lcom/android/server/BackupManagerService$BackupHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    .end local v2           #params:Lcom/android/server/BackupManagerService$FullRestoreParams;
    :cond_0
    const-string v3, "BackupManagerService"

    const-string v4, "Possible HTC backup spoof, ignoring:"
    ...
    const-string v4, "Calling package name not allowed."
...
.method public registerTransportPrivileged(Ljava/lang/String;Lcom/android/internal/backup/IBackupTransport;)V
    .locals 5
    .parameter "name"
    .parameter "transport"
    ...
    const-string v2, "Possible HTC backup spoof, ignoring:"
    ...
    const-string v2, "Calling package name not allowed."
...
.method resetBackupState(Ljava/io/File;)V
    ...
    const-string v11, "stateFileDir is null when resetBackupState, do nothing"
